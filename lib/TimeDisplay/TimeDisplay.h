...
class SevenSegment : public TM1637Display
{
    ...
    void display_station(uint station); //display the current radio station (when in radio select mode)
    void Update(bool dots = true); //update display based on RadioTime reference
